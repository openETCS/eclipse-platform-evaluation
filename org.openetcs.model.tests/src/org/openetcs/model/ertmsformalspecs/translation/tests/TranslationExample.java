...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>translation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TranslationExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TranslationPackage.eNS_URI, 
			 TranslationPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.translation"));
				TranslationFolder root = TranslationFactory.eINSTANCE.createTranslationFolder();
