...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.types.Collection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addMaximumSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collection_maximumSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Collection_maximumSize_feature", "_UI_Collection_type"),
				 TypesPackage.Literals.COLLECTION__MAXIMUM_SIZE,
				 true,
				 false,
				 false,
