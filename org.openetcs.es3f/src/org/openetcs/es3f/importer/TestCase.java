...
public class TestCase
	extends org.openetcs.es3f.importer.generated.TestCase
{
	private static final long serialVersionUID = 2829494552401902711L;

	public org.openetcs.model.ertmsformalspecs.test.SingleTestCase convert2EMF( ECPProject project )
	{
		...
		retVal.setFeature(getFeature());
		retVal.setCase(getCase());
		...
		if ( allSteps() != null )
		{
			...
			{
				retVal.getSteps().add(((Step) obj).convert2EMF( project ));	
			}
		}
