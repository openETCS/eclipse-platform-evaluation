...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.test.Expectation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpectationItemProvider
	...
	protected void addBlockingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expectation_blocking_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expectation_blocking_feature", "_UI_Expectation_type"),
				 TestPackage.Literals.EXPECTATION__BLOCKING,
				 true,
				 false,
				 false,
	...
	protected void addDeadlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expectation_deadline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expectation_deadline_feature", "_UI_Expectation_type"),
				 TestPackage.Literals.EXPECTATION__DEADLINE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Expectation)object).getVariable();
