...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>customization</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomizationExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(CustomizationPackage.eNS_URI, 
			 CustomizationPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.customization"));
				RuleDisabling root = CustomizationFactory.eINSTANCE.createRuleDisabling();
