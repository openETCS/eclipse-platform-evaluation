...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.types.Case} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Case_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Case_expression_feature", "_UI_Case_type"),
				 TypesPackage.Literals.CASE__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.CASE__PRE_CONDITIONS);
		}
	...
	public String getText(Object object) {
		String label = ((Case)object).getExpression();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.CASE__PRE_CONDITIONS,
