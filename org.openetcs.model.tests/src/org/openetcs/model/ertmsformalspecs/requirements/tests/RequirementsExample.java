...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>requirements</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.requirements"));
				Specification root = RequirementsFactory.eINSTANCE.createSpecification();
