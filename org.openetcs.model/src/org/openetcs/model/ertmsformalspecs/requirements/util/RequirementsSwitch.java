...
public class RequirementsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RequirementsPackage.SPECIFICATION: {
				...
				if (result == null) result = caseBaseLinedElement(specification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementsPackage.BASE_LINED_ELEMENT: {
				BaseLinedElement baseLinedElement = (BaseLinedElement)theEObject;
				T result = caseBaseLinedElement(baseLinedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementsPackage.FUNCTIONAL_BLOCK: {
				FunctionalBlock functionalBlock = (FunctionalBlock)theEObject;
				T result = caseFunctionalBlock(functionalBlock);
				if (result == null) result = caseNamedElement(functionalBlock);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementsPackage.PROCESS_INFORMATION: {
				ProcessInformation processInformation = (ProcessInformation)theEObject;
				T result = caseProcessInformation(processInformation);
				if (result == null) result = caseCommentedElement(processInformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RequirementsPackage.SCOPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Functional Block</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Functional Block</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionalBlock(FunctionalBlock object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Process Information</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Process Information</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProcessInformation(ProcessInformation object) {
		return null;
	}
