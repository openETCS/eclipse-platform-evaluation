...
fl1102 = acceptor.lAccept_Folder(ctxt, "</Folder>");
appendFolders(fl1102);
ctxt.skipWhiteSpace();
} // -- monomorphic Loop
// EndRepeat
ctxt.skipWhiteSpace();
...
fl1115 = acceptor.lAccept_Translation(ctxt, "</Translation>");
appendTranslations(fl1115);
ctxt.skipWhiteSpace();
} // -- monomorphic Loop
// EndRepeat
ctxt.skipWhiteSpace();
