...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.requirements.messages.SpecialOrReservedValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecialOrReservedValueItemProvider
	 ...
	 * @generated
	 */
	public SpecialOrReservedValueItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MASK);
			childrenFeatures.add(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MATCH);
			childrenFeatures.add(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MEANING);
			childrenFeatures.add(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__VALUE);
		}
	...
	/**
	 * This returns SpecialOrReservedValue.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SpecialOrReservedValue"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_SpecialOrReservedValue_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SpecialOrReservedValue.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MASK,
				 MessagesFactory.eINSTANCE.createMask()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MATCH,
				 MessagesFactory.eINSTANCE.createMatch()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MATCH,
				 MessagesFactory.eINSTANCE.createMatchRange()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__MEANING,
				 MessagesFactory.eINSTANCE.createMeaning()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.SPECIAL_OR_RESERVED_VALUE__VALUE,
				 MessagesFactory.eINSTANCE.createSingleValue()));
	}
