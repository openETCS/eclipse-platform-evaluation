	...
	protected void addParentNamespacePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_parentNamespace_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_parentNamespace_feature", "_UI_Variable_type"),
				 ModelPackage.Literals.VARIABLE__PARENT_NAMESPACE,
				 true,
				 false,
				 true,
				 null,
