...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.requirements.messages.TypeValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeValue_resolutionFormula_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeValue_resolutionFormula_feature", "_UI_TypeValue_type"),
				 MessagesPackage.Literals.TYPE_VALUE__RESOLUTION_FORMULA,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MessagesPackage.Literals.TYPE_VALUE__RESOLUTION_FORMULA);
			childrenFeatures.add(MessagesPackage.Literals.TYPE_VALUE__SPECIAL_OR_RESERVED_VALUES);
		}
	...
	public String getText(Object object) {
		return getString("_UI_TypeValue_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.TYPE_VALUE__RESOLUTION_FORMULA,
				 MessagesFactory.eINSTANCE.createResolutionFormula()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.TYPE_VALUE__SPECIAL_OR_RESERVED_VALUES,
				 MessagesFactory.eINSTANCE.createSpecialOrReservedValue()));
	}
