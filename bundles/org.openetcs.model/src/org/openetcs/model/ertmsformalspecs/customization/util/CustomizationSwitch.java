/**
 */
package org.openetcs.model.ertmsformalspecs.customization.util;
...
public class CustomizationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CustomizationPackage.RULE_DISABLING: {
				RuleDisabling ruleDisabling = (RuleDisabling)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rule Disabling</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rule Disabling</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRuleDisabling(RuleDisabling object) {
		return null;
	}
