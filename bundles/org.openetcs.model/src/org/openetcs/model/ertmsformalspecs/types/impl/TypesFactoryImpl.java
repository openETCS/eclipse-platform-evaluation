...
public class TypesFactoryImpl extends EFactoryImpl implements TypesFactory {
	...
	public static TypesFactory init() {
		try {
			TypesFactory theTypesFactory = (TypesFactory)EPackage.Registry.INSTANCE.getEFactory("http://org/openetcs/ertmsformalspecs/types"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TypesPackage.STRUCTURE_ELEMENT: return createStructureElement();
			case TypesPackage.COLLECTION: return createCollection();
			case TypesPackage.FUNCTION: return createFunction();
