...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.requirements.messages.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MessagesPackage.Literals.MESSAGE__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MessagesPackage.Literals.MESSAGE__VARIABLES);
			childrenFeatures.add(MessagesPackage.Literals.MESSAGE__MEDIA);
		}
	...
	public String getText(Object object) {
		String label = ((Message)object).getDescription();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.MESSAGE__VARIABLES,
				 MessagesFactory.eINSTANCE.createMessageVariable()));

		newChildDescriptors.add
			(createChildParameter
				(MessagesPackage.Literals.MESSAGE__MEDIA,
				 MessagesFactory.eINSTANCE.createMedia()));
	}
