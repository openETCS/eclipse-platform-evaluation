...
public class ProcedureItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PROCEDURE__PARAMETERS);
			childrenFeatures.add(ModelPackage.Literals.PROCEDURE__STATE_MACHINE);
			childrenFeatures.add(ModelPackage.Literals.PROCEDURE__RULES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.PROCEDURE__PARAMETERS,
