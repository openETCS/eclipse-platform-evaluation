...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.translation.Translation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TranslationItemProvider
	...
	protected void addImplementedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Translation_implemented_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Translation_implemented_feature", "_UI_Translation_type"),
				 TranslationPackage.Literals.TRANSLATION__IMPLEMENTED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TranslationPackage.Literals.TRANSLATION__SOURCES);
			childrenFeatures.add(TranslationPackage.Literals.TRANSLATION__SUB_STEPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TranslationPackage.Literals.TRANSLATION__SOURCES,
				 TranslationFactory.eINSTANCE.createSourceText()));

		newChildDescriptors.add
			(createChildParameter
				(TranslationPackage.Literals.TRANSLATION__SUB_STEPS,
