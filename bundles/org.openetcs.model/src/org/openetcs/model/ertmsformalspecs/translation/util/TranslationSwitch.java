 ...
 * @generated
 */
public class TranslationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TranslationPackage.TRANSLATION_FOLDER: {
				TranslationFolder translationFolder = (TranslationFolder)theEObject;
				T result = caseTranslationFolder(translationFolder);
				if (result == null) result = caseNamedElement(translationFolder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TranslationPackage.TRANSLATION: {
				Translation translation = (Translation)theEObject;
				T result = caseTranslation(translation);
				if (result == null) result = caseNamedElement(translation);
				if (result == null) result = caseCommentedElement(translation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TranslationPackage.SOURCE_TEXT: {
				SourceText sourceText = (SourceText)theEObject;
				T result = caseSourceText(sourceText);
				if (result == null) result = caseNamedElement(sourceText);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseTranslationFolder(TranslationFolder object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Source Text</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Source Text</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSourceText(SourceText object) {
		return null;
	}
