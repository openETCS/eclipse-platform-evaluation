...
/**
 * This is the item provider adapter for a {@link org.openetcs.model.ertmsformalspecs.requirements.messages.Match} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatchItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Match_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Match_value_feature", "_UI_Match_type"),
				 MessagesPackage.Literals.MATCH__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Match)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Match.class)) {
			case MessagesPackage.MATCH__VALUE:
