...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>shortcut</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ShortcutExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ShortcutPackage.eNS_URI, 
			 ShortcutPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.shortcut"));
				ShortcutFolder root = ShortcutFactory.eINSTANCE.createShortcutFolder();
