...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>messages</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MessagesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.messages"));
				TypeSpec root = MessagesFactory.eINSTANCE.createTypeSpec();
