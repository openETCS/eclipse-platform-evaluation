...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>behaviour</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviourExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.behaviour"));
				Rule root = BehaviourFactory.eINSTANCE.createRule();
